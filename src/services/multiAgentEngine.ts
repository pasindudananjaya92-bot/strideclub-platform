...
export const DEFAULT_WORKFLOWS: AgentWorkflowDefinition[] = [
  {
    ...
    nodes: [
      ...
      { id: 'node-planner', type: 'agent', label: 'Pasiya Planner Agent', service: 'Gemini 2.0 Flash', status: 'idle' },
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: 'ps-planner', type: 'agent', label: 'Replit Multi-Step Planner', service: 'Gemini 2.0 Flash', status: 'idle' },
