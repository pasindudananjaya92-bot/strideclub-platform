...
const PREDEFINED_SERVICES: PredefinedService[] = [
  ...
  },
  {
    ...
    category: 'Automation',
    description: 'Autonomous repository sync, direct code commits, and project pushing to your GitHub repo.',
    fields: [
      {
        key: 'apiKey',
        ...
        helpText: 'Generated in GitHub Settings -> Developer Settings -> Personal access tokens (classic) with repo permissions.',
        required: true,
      },
      {
        key: 'endpointUrl',
        label: 'GitHub Repository Full Name (owner/repo)',
        type: 'text',
        placeholder: 'username/strideclub-platform',
        helpText: 'The target GitHub repository where the autonomous agent will push files.',
        required: true,
      },
    ],
  },
